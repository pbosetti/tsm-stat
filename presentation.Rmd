...
corso <- tribble(
  ~argomento, ~ore, ~fonte,
  "Richiami di statistica", 5, "slide pdf",
  "L'ambiente RStudio", 1, knitr::current_input(),
  "Il linguaggio R", 3, knitr::current_input(),
  "Modelli di regressione lineare e lineare generalizzata", 2, "reglin.Rmd",
  "Serie temporali e modelli ARIMA", 3, "ARIMA.Rmd",
  "*Tidyverse*", 4, "tidy.Rmd",
  "Mappe e GIS", 3, "maps.Rmd"
)
```
...
corso %>%pwalk(~cat(paste0("1. ",..1, ", ", ..2, "h *(", ..3, ")*" ), sep="\n"))
cat("\n* **TOTALE: ", sum(corso$ore), "h**")
```
...
sample(1:10, size = 5)
sample(10) # generazione interi casuali senza rpetizione
```
